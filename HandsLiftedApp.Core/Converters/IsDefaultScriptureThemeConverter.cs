...
namespace HandsLiftedApp.Core.Converters
{
    ...
    // Playlist.DefaultScriptureThemeId raises PropertyChanged on the Playlist, not on the bound
    ...
    public class IsDefaultScriptureThemeConverter : IMultiValueConverter
    {
