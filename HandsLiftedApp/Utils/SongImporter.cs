...
namespace HandsLiftedApp.Utils
{
    public static class SongImporter
    {
        ...
        public static SongItem<SongTitleSlideStateImpl, SongSlideStateImpl, ItemStateImpl> createSongItemFromTxtFile(string txtFilePath)
        {
            string text = File.ReadAllText(txtFilePath);
            return createSongItemFromStringData(text);
        }

        public static SongItem<SongTitleSlideStateImpl, SongSlideStateImpl, ItemStateImpl> createSongItemFromStringData(string text)
        {
