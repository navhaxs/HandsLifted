...
namespace HandsLiftedApp.Views.Render.VideoRendering;
...
public class MpvOpenGlVideoView : OpenGlControlBase
{
    ...
    public static readonly DirectProperty<MpvOpenGlVideoView, MpvContext?> MpvContextProperty =
           AvaloniaProperty.RegisterDirect<MpvOpenGlVideoView, MpvContext?>(
               nameof(MpvContext),
               o => o.MpvContext,
               (o, v) => o.MpvContext = v,
